...
static const char pink[]            = "#fd5cf6";
static const char blue[]	    = "#301686";
static const char cyan[]	    = "#5fbcf3";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { cyan, blue, blue },
	[SchemeSel]  = { blue, pink, pink    },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", blue, "-nf", pink, "-sb", pink, "-sf", blue, NULL };
